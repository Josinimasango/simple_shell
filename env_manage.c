...
/**
 * env_get_key - gets a value of the environment variable
...
/**
 * env_set_key - overwrites value of the environment variable
 ...
 * @key: key to be remove
 * @data: the sructure of data
