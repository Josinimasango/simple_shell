#include "shell.h"
/**
 * main - initializes the variables
...
/**
 * handle_ctrl_c - prints prompt of a new line
...
/**
 * inicialize_data - initializes the struct with the info
...
/**
 * sisifo - its a loop that shows the prompt
