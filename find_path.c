...
/**
 * find_program - finds program in the path
 * @data: pointer data
...
/**
 * tokenize_path - tokenizes path in the directories
 * @data: pointer data
...
/**
 * check_file - checks if it exists a file, if its not a dairectory and
